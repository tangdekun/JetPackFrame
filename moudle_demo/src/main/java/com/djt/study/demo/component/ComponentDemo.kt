package com.djt.study.demo.component
 ...
 * @author billy.qi
 */
class ComponentDemo : IComponent {
    //组件的名称，调用此组件的方式：
    // CC.obtainBuilder("ComponentDemo")...build().callAsync()
    val name: String
        @Override
        get() = "ComponentDemo"
    ...
    private fun openActivity(cc: CC) {
        CCUtil.navigateTo(cc, DemoActivity::class.java)
