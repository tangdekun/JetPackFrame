...
class StringUtils private constructor() {
    ...
    companion object {
        ...
        fun equalsIgnoreCase(a: String?, b: String?): Boolean {
            return if (a == null) b == null else a.equals(b,true)
        }
        ...
        fun upperFirstLetter(s: String): String {
            return if (isEmpty(s) || !Character.isLowerCase(s[0])) s else (s[0]- 32).toString() + s.substring(
                1
            )
        }
        ...
        fun lowerFirstLetter(s: String): String {
            return if (isEmpty(s) || !Character.isUpperCase(s[0])) s else (s[0] + 32) .toString() + s.substring(
                1
            )
        }
